 ...
 * @author Zikri
 */
public class UbahProdukFrame extends javax.swing.JFrame {
    ...
    private void buttonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSubmitActionPerformed
        ...
        try {
            ...
            Logger.getLogger(UbahProdukFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (status == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UbahProdukFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UbahProdukFrame().setVisible(true);
            }
        });
    }
